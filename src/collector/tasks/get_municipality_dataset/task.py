...
class GetMunicipalityDataset:
    ...
    def run(self, inputs):
        ...
        data = pd.merge(
            cases_data,
            hospitalized_data[["Municipality_code", "Hospital_admission"]],
